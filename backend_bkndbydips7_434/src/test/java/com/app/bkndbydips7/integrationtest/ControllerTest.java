...
class ControllerTest {
  ...
  void  testCreateOrganizationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips7/Organizations")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips7/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/bkndbydips7/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips7/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips7/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips7/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips7/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips7/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips7/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM bkndbydips7.Organization");
    jdbcTemplate.execute("DELETE FROM bkndbydips7.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM bkndbydips7.EmlpoyeeProfile");
